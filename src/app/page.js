  ...
  useEffect(() => {
    ...
    async function loadGalleryData() {
      ...
      try {
        ...
        // Extract slider images from API response
        ...
        if (mounted) {
          ...
          // remove only slider keys but keep other folders
...
<motion.div
      ...
      />
          ...
          <motion.div 
            className="flex justify-center items-center rounded-3xl shadow-2xl bg-black/30 backdrop-blur-md border border-[#c9a35e]/30"
            style={{ height: "65vh" }}
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="text-center">
              <p className="text-xl text-[#f5f5f1] mb-4">No hero images uploaded yet</p>
              <p className="text-sm text-[#c9a35e]">Please upload images from the dashboard</p>
            </div>
          </motion.div>
        )}
      </div>
      ...
      >
        ...
        <div className="max-w-5xl mx-auto text-center px-4 sm:px-6 relative z-10">
          ...
          <motion.p 
            ...
            variants={itemVariants}
          >
            AR Foundation supports communities through education, healthcare, and empowerment initiatives.
          </motion.p>
      ...
      <section ref={youtubeRef} className="py-12 sm:py-16 max-w-6xl mx-auto px-4 sm:px-6">
        ...
        {allYoutubeItems.length === 0 ? (
          ...
          >
            No YouTube videos yet. Please add videos from the dashboard.
          </motion.div>
        ) : (
          <motion.div 
